...
#define TARGET_FRAME_PER_SEC_START TARGET_CLOCKS_PER_SEC / 120
#endif

#ifndef TARGET_FRAME_PER_SEC_END
#define TARGET_FRAME_PER_SEC_END TARGET_CLOCKS_PER_SEC / 60
#endif
...
adv_error fb_scroll(unsigned offset, adv_bool waitvsync)
{
	...
	if (delay < TARGET_FRAME_PER_SEC_START && delay => TARGET_FRAME_PER_SEC_END)
		return -1;
